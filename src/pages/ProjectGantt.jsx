...
export default function ProjectGantt() {
    ...
    return (
        <div className="-m-4 md:-m-8 flex flex-col bg-slate-950 text-white" style={{ minHeight: '100vh' }}>
            ...
            {/* ======== HEADER ======== */}
            <div className="flex-shrink-0 border-b border-slate-800 bg-slate-900/70 backdrop-blur-sm px-6 py-4">
                <div className="flex items-center justify-between gap-4 flex-wrap">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-lg font-black text-white leading-none">Project Gantt</h1>
                            <p className="text-[11px] text-slate-400 font-medium mt-0.5">Diagrama de barras de proyecto</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                        {/* View toggle */}
                        <div className="flex items-center bg-slate-800 rounded-xl p-1 gap-1 border border-slate-700">
                            <button
                                onClick={() => setViewMode('weekly')}
                                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${viewMode === 'weekly' ? 'bg-indigo-600 text-white shadow-md' : 'text-slate-400 hover:text-white'}`}
                            >
                            ...
                            <button
                                ...
                                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${viewMode === 'monthly' ? 'bg-indigo-600 text-white shadow-md' : 'text-slate-400 hover:text-white'}`}
                            >
                        ...
                        {/* Navigation */}
                        <div className="flex items-center gap-1 bg-slate-800 rounded-xl border border-slate-700 px-1 py-1">
                            <button onClick={() => navigate(-1)} className="p-1.5 rounded-lg text-slate-400 hover:text-white hover:bg-slate-700 transition-all">
                                <ChevronLeft className="w-4 h-4" />
                            </button>
                            <button onClick={goToday} className="px-2.5 py-1 rounded-lg text-xs font-bold text-slate-300 hover:text-white hover:bg-slate-700 transition-all whitespace-nowrap">
                                Hoy
                            </button>
                            <button onClick={() => navigate(1)} className="p-1.5 rounded-lg text-slate-400 hover:text-white hover:bg-slate-700 transition-all">
                    ...
                    {/* Range label */}
                    <div className="flex items-center gap-1.5 px-3 py-2 bg-slate-800/60 rounded-xl border border-slate-700/50">
                    ...
                    <select
                        ...
                        className="bg-slate-800 border border-slate-700 rounded-lg px-2.5 py-1.5 text-xs text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 max-w-[150px]"
                    >
                    ...
                    <select
                        ...
                        className="bg-slate-800 border border-slate-700 rounded-lg px-2.5 py-1.5 text-xs text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 max-w-[130px]"
                    >
                    ...
                    {canEdit && (
                        <button
                            onClick={openNew}
                            className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-black bg-indigo-600 hover:bg-indigo-500 text-white border border-indigo-500 shadow-lg shadow-indigo-500/20 transition-all"
                        >
