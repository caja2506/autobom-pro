                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" min="1" step="1" value={formData.leadTimeWeeks}
                            ...
                            placeholder="Ej: 4"
                            className="w-full p-3 border rounded-xl bg-slate-50 font-bold outline-none focus:ring-2 focus:ring-teal-500" />
                        ...
                        {ltChanged && (
                            <label className="flex items-center gap-2 mt-2 p-2 bg-amber-50 rounded-lg border border-amber-200 cursor-pointer">
                                ...
                                <span className="text-xs font-bold text-amber-700">¿Actualizar también en el catálogo maestro?</span>
                            </label>
                        )}
                    </div>
                </div>
